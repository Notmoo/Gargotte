...
public class Controller implements Initializable {
    ...
    @FXML
    private Label TotalGainStatTabLabel; //Montant total des ventes
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //On met à jour l'affichage des statistiques de l'onglet "Stats"
        updateStatDisplay();
    }
    ...
    // Met à jour le texte affiché sur les labels dans l'onglet "Stats"
    private void updateStatDisplay(){
        TotalFreeGainStatTabLabel.setText(new Double(model.getAmountGifts()).toString());
        TotalFreeNumberStatTabLabel.setText(new Integer(model.getNumberGifts()).toString());
        TotalNumberStatTabLabel.setText(new Integer(model.getNumberSales()).toString());
        TotalGainStatTabLabel.setText(new Double(model.getAmountSales()).toString());
    }
    ...
    private void validation(){
        ...
        if(saveSoldItem()) {
            ...
            clearPaymentMethodSelection(null);
    ...
    private void liquidePaymentMethodSelected(){
        if(LiquidePaymentMethodRadioButton.isSelected()) {
            clearPaymentMethodSelection(LiquidePaymentMethodRadioButton);
            ValidationButton.setText("Validation");
        }
    }
    @FXML
    private void chequePaymentMethodSelected(){
        if(ChequePaymentMethodRadioButton.isSelected()) {
            clearPaymentMethodSelection(ChequePaymentMethodRadioButton);
            ValidationButton.setText("Validation");
        }
    }
    @FXML
    private void compteAEPaymentMethodSelected(){
        if(CompteAEPaymentMethodRadioButton.isSelected()) {
            clearPaymentMethodSelection(CompteAEPaymentMethodRadioButton);
            ValidationButton.setText("Validation");
        }
    }
    @FXML
    private void freeGuestPaymentMethodSelected(){
        if(FreeGuestPaymentMethodRadioButton.isSelected()) {
            clearPaymentMethodSelection(FreeGuestPaymentMethodRadioButton);
            ValidationButton.setText("Validation");
        }
    }
    @FXML
    private void freeStaffPaymentMethodSelected(){
        if(FreeStaffPaymentMethodRadioButton.isSelected()) {
            clearPaymentMethodSelection(FreeStaffPaymentMethodRadioButton);
            ValidationButton.setText("Validation");
        }
    }
    ...
    private void clearPaymentMethodSelection(RadioButton exceptIt){
        for(RadioButton current : radioButtonList){
            if(!current.equals(exceptIt))
