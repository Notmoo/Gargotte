...
public class ModeleDAO {
    ...
    private final ArrayList<items.Produit> dbProduits;
    ...
    public ArrayList<items.Produit> getDBProduits() {
        return dbProduits;
    }
        ...
        */
        ...
        while (itMenu.hasNext()) {
            ...
            try {
                ...
                items.Produit thisMenu = new items.Produit(current.getChildText("nom"), prix, "menu", stock, vente);
